    ...
    <div className="min-h-screen bg-gray-900 text-gray-100 font-sans">
      ...
      <nav className="bg-gray-800 p-4">
        <div className="container mx-auto flex justify-between items-center">
          <a href="#" className="text-2xl font-bold text-blue-400">VoiceGuard</a>
      ...
      <section className="container mx-auto py-20 text-center">
        ...
        <p className="text-xl mb-8">Join thousands of users who trust VoiceGuard for real-time phishing protection.</p>
      ...
      <footer className="bg-gray-800 py-8">
        <div className="container mx-auto text-center">
          <p>&copy; 2024 VoiceGuard. All rights reserved.</p>
        </div>
      </footer>
